...
public class TotalStatisticsOfSymbols {
    char[] textChars;
    Map<Character, Integer> symbolFrequencyMap = new HashMap<Character, Integer>(); // -- Map --
    List<Character> symbols = new ArrayList<>(); // -- список ключей Map --
    List<Integer> frequency = new ArrayList<>();   // -- список значений ключей Map --
    int totalNumber = 1;
